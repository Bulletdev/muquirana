...
- **Styling**: Tailwind CSS v4.x with custom design system
  - Design system defined in `app/assets/tailwind/muquirana-design-system.css`
...
- **Always reference `app/assets/tailwind/muquirana-design-system.css`** for primitives and tokens
