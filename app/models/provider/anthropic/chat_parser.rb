class Provider::Anthropic::ChatParser
  ...
  # Converte uma Anthropic::Message (SDK) para o contrato LlmConcept que o
  # assistant consome (ChatResponse / ChatMessage / ChatFunctionRequest).
      ...
      content_blocks
        ...
        .map do |block|
          ...
          ChatFunctionRequest.new(
            ...
            # O contrato espera function_args como STRING JSON (o assistant faz
            # JSON.parse depois). A Anthropic devolve input ja como Hash.
