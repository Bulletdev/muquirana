# Traz a tona despesas recorrentes bem passadas de sua data esperada -- o
# fornecedor pode ter aumentado o preco, a cobranca pode ter mudado, ou o
# usuario pode estar pagando por algo que parou quietinho (ou deveria parar). O
# limiar e em dias, entao nao depende da moeda.
  ...
  def generate
    overdue_recurring.map do |recurring|
      ...
      build_insight(
        ...
        # days_overdue fica de fora de proposito: muda toda noite, e a deriva de
        # metadata ressuscitaria insights que o usuario ja dispensou.
        metadata: {
