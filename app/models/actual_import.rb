class ActualImport < Import
  ...
  private
    ...
    # O Actual Budget exporta linhas de reconciliacao e de saldo inicial com o
    # Payee em branco. O Entry exige um nome, entao caimos na coluna Notes (que
    # costuma trazer algo como "Reconciliation balance adjustment") e por fim no
    # default generico, espelhando o tratamento de nome em branco do Import e do
    # MintImport.
    def row_name(row)
